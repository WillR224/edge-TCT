...
On Windows:
	...
	4. The library with dependencies is located in the ximc/win** folders. For the example to work, you need the following files: bindy.dll, libximc.dll, xiwrapper.dll.
...
===== ЗАПУСК =====
Windows:
	1. Для использования библиотеки libximc.dll в среде .NET предлагается обертка ximc/win**/wrappers/csharp/ximcnet.dll для операционной системы разной разрядности.
	2. Поддерживаются платформы .NET от 2.0 до 4.0.
	3. Для сборки и запуска примера можно использовать среду Visual Studio 2013.
	4. Библиотека с зависимостями расположена в папках ximc/win**. Для работы примера необходимы файлы: bindy.dll, libximc.dll, xiwrapper.dll.
